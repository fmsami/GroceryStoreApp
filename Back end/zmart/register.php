            ...
            <div class="col-lg-12 col-xl-6">
                <form action="" method="post" enctype="multitype/form-data">
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" id="user_fname" class="form-control" placeholder="Enter your first name" required="required" name="user_fname">
                    </div>
                    <div class="form-outline mb-4">
                        <label for="user_lname" class="form-label">Last Name</label>
                        <input type="text" id="user_lname" class="form-control" placeholder="Enter your last name" required="required" name="user_lname">
                    </div>
                    <div class="form-outline mb-4">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" id="user_add" class="form-control" placeholder="Enter your address" required="required" name="user_add">
                    </div>
                    <div class="form-outline mb-4">
                    ...
                    <div class="text-center">
                        <input type="submit" value="Register" class="bg-success text-light py-2 px-3 border-0 name="register">
                    </div>
